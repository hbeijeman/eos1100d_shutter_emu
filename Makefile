CFLAGS=-DSTM32F042 -c -Isrc -Isrc/stm32f0xx_lib -mcpu=cortex-m0 -ffreestanding -mthumb -std=c99 -fno-delayed-branch -fno-defer-pop -fno-exceptions -ffunction-sections -fdata-sections -g -ggdb -g3 -O0
